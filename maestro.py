...
class Controller:
    ...
    # Typcially valid servo range is 4000 to 8000 quarter-microseconds
    ...
    # A value of 1 will take the servo about 3s to move between 1ms to 2ms ruange.
    ...
    # Get the current position of the device on the specificed channel
